...
def update_or_create_user_tokens(session_key, access_token, token_type, expires_in, refresh_token):
    ...
    if tokens:
        ...
        tokens.refres_token = refresh_token
        tokens.expires_in = expires_in
        tokens.token_type = token_type
        tokens.save(update_fields=['access_token', 'refres_token', 'expires_in', 'token_type'])
    else :
...
def refresh_spotify_token(session_key):
    ...
    response = post('https://accounts.spotify.com/api/tokne', data={
